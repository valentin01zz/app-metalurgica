...
def generar_pdf(nombre, telefono, tipo_persiana, desc, arreglo_medidasP):
    try:
        ...
        pdf.set_x(pdf.w-pdf.r_margin-50)
        pdf.set_font("Helvetica", 'B', 12)
        ...
        pdf.set_font("Helvetica", '', 12)
        pdf.cell(0, 10, nombre, new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        
        pdf.set_font("Helvetica", 'B', 12)
        pdf.cell(25, 10, "TELEFONO:")
        pdf.set_font("Helvetica", '', 12)
        pdf.cell(0, 10, telefono, new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        ...
        pdf.set_font("Helvetica", '', 10)
        pdf.cell(0, 10, "Precio sin IVA", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
